document.addEventListener('DOMContentLoaded', () => {
  ...
  // SIMULASI STATUS LOGIN (Anda bisa mengganti ini dengan logika autentikasi yang sebenarnya)
  ...
  signInBtn.addEventListener('click', () => {
    // Di sini Anda akan mengarahkan pengguna ke halaman login Anda
    window.location.href = 'halaman_login.html'; // Contoh: ganti dengan URL halaman login Anda
  ...
  if (favoritesNavLink) {
    favoritesNavLink.addEventListener('click', function (e) {
      ...
      if (!isLoggedIn) {
        ...
        window.location.href = 'profil.html'; // Contoh: ganti dengan URL halaman profil Anda
      }
    });
  }
