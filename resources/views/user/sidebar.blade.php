    ...
    <ul>
      <li>
        <a href="{{ url('/') }}" style="text-decoration: none; color: inherit;">
          <i class='bx bx-home-alt sidebar-icon'></i> Home
        </a>
      </li>
      ...
      <li id="collectionsSidebarLink">
        <a href="{{ route('collections.az') }}" style="text-decoration: none; color: inherit;">
      ...
      <li class="media-link">
        <a href="{{ route('media.home') }}" style="text-decoration: none; color: inherit;">
