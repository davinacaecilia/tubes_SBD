...
<head>
    ...
    <title>Add New Media - Google Arts & Culture Admin</title> <!-- Translated -->
    <style>
        ...
        /* .form-group input[type="file"], <-- Keep as per user's last command, but it's not used below */
        .form-group textarea,
        .form-group select {
            width: 100%;
            padding: 10px 12px;
                ...
                <form action="{{ route('admin.media.store') }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="desc" name="desc" placeholder="Brief description of the media" rows="5"></textarea> 
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-submit">
                            <i class='bx bx-save'></i> Save Media
                        </button> 
                    </div>
                </form>
            </div>
